...
# Usa la chiave API nel tuo codice
st.write(f"Chiave API caricata: {GOOGLE_API_KEY}")
...
tickers_input = st.sidebar.text_input("Inserisci Stock Tickers (separati da virgola):", "AAPL,MSFT,GOOG")
